"""
Django settings for falling_pine_4 project.
...
ROOT_URLCONF = 'falling_pine_4.urls'
...
WSGI_APPLICATION = 'falling_pine_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_pine_4 API",
    "DESCRIPTION": "API documentation for falling_pine_4 App",
    "VERSION": "v1",
}
